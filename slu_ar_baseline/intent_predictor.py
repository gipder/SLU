...
class ConvIntentPredictionModule(nn.Module):
    """
    ...
    def __init__(
        ...
        # final intent predictor
        self.intent_pred = nn.Linear(embed_dim, num_intent)
...
class MaskedIntentPredictionModule(nn.Module):
    def __init__(
        self,
        embed_dim: int,
        ...
        self.lengths_pred = nn.Linear(length_hidden_dim, num_intent)
        self.length_dropout = length_dropout
...
if __name__ == "__main__":
    ...
    model = ConvIntentPredictionModule(
        embed_dim=C,
        conv_dim=256,
        num_intent=128,
        length_dropout=0.2,
    ...
    model2 = MaskedIntentPredictionModule(
        embed_dim=C,
